...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.viewHolder> {
    ...
    public void addAllItem(ArrayList<NotificationList> notificationLists) {
        this.arrayList.clear();
        this.arrayList.addAll(notificationLists);
        notifyDataSetChanged();
    }

    public void addItem(NotificationList notificationList) {
        this.arrayList.add(notificationList);
        notifyDataSetChanged();
    }
    ...
    public NotificationList getSuggestMessageList(int postion) {
