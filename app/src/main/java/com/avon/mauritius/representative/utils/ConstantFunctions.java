...
public class ConstantFunctions {
    ...
    public static float convertDpToPixel(float dp){
        return dp * ((float) Myapplication.getContext().getResources().getDisplayMetrics().densityDpi / DisplayMetrics.DENSITY_DEFAULT);
    }
    public static float convertPixelsToDp(float px){
        return px / ((float) Myapplication.getContext().getResources().getDisplayMetrics().densityDpi / DisplayMetrics.DENSITY_DEFAULT);
    }
    ...
    public static void loadImageForEeventList(String url, final ImageView iv) {
    ...
    public static void loadImageNomaForProfilel(String url, final ImageView iv) {

        if (url.startsWith("https") || url.startsWith("http")) {
            Log.e("sdasdasdasd....2", "are" + url);
            Glide.with(Myapplication.getContext()).asBitmap()
                    .load(url)
                    .error(R.mipmap.ic_launcher_round)
                    .fitCenter()
                    .apply(requestOptionsCircel)
                    .into(iv);
        }
    ...
    public static void webIntntCall(String web_url) {
        ...
        Intent newIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(web_url));
    ...
    public static void shareText(String subject, String body) {
        try {
            ...
            Myapplication.getContext().startActivity(Intent.createChooser(txtIntent, "Share"));
