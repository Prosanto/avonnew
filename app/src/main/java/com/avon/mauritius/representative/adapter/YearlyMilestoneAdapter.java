...
public class YearlyMilestoneAdapter extends BaseAdapter {
    ...
    public YearlyMilestoneAdapter(Context context, List<QuarterlyData> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context)
                    .inflate(R.layout.row_yearly_milestone, parent, false);
