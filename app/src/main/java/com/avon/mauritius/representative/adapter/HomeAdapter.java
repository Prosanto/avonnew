...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.viewHolder> {
    ...
    public HomeAdapter(Context context, ArrayList<ProductList> arrayList) {
    ...
    public ArrayList<ProductList> addAllItem() {
        return arrayList;
    }
    ...
    public void onBindViewHolder(viewHolder viewHolder, int position) {
        ...
        try {
            viewHolder.layoutview.getLayoutParams().height = layoutHeight();
    ...
    public int layoutHeight() {
        int fullFull = 460;
        int remain = (int) (ConstantFunctions.getScreenHeight() - ConstantFunctions.convertDpToPixel(fullFull));
        remain = remain / 2;
        return remain;
